...
const Logo: React.FC<SvgPropTypes> = ({ size = 48 }) => (
  <svg width={size} viewBox="0 0 47 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask
      id="mask0_0_1"
    ...
    >
      <path
        d="M42.9399 27.7976C43.6061 27.0531 44.1262 26.1629 44.451 25.2054C44.8914 24.1533 45.1189 22.9476 44.9041 21.8191C44.8146 21.3489 44.6615 20.917 44.4408 20.5077C44.3022 20.116 44.1236 19.742 43.9171 19.3799C43.3921 18.4594 42.6376 17.7161 41.7853 17.122C39.8926 15.8027 37.5412 15.4378 35.3037 15.4363C33.84 15.4354 32.335 15.5238 30.9097 15.9048C30.8863 16.0653 30.0187 19.4285 27.9946 21.2411C27.6185 21.5963 24.8666 23.0866 24.7838 23.1004C24.7552 23.6624 24.8187 24.213 24.9735 24.7539C25.2674 25.7812 25.9678 26.6452 26.7607 27.3071C28.4379 28.7068 30.512 29.5722 32.6172 29.9927C32.9576 30.1067 36.8408 30.6723 38.3878 30.2763C38.6567 30.2723 39.462 30.1513 39.4946 30.1411C41.4709 31.4301 45.6425 34.035 45.7477 33.9997C45.9396 33.9399 46.0989 33.787 46.2138 33.6228C46.3486 33.4299 43.961 29.4246 42.9399 27.7978V27.7976Z"
        fill="white"
      />
    </mask>
    <g mask="url(#mask0_0_1)">
      <path
        d="M42.7512 27.7976C43.4174 27.0531 43.9375 26.1629 44.2622 25.2054C44.7027 24.1533 44.9302 22.9476 44.7153 21.8191C44.6259 21.3489 44.4728 20.917 44.2521 20.5077C44.1134 20.116 43.9349 19.742 43.7283 19.3799C43.2034 18.4594 42.4489 17.7161 41.5966 17.122C39.7039 15.8027 37.3525 15.4378 35.1149 15.4363C33.6512 15.4354 32.1463 15.5238 30.721 15.9048C30.6976 16.0653 29.83 19.4285 27.8059 21.2411C27.4298 21.5963 24.6778 23.0866 24.595 23.1004C24.5664 23.6624 24.63 24.213 24.7848 24.7539C25.0787 25.7812 25.7791 26.6452 26.572 27.3071C28.2492 28.7068 30.3233 29.5722 32.4285 29.9927C32.7688 30.1067 36.6521 30.6723 38.1991 30.2763C38.468 30.2723 39.2732 30.1513 39.3058 30.1411C41.2821 31.4301 45.4538 34.035 45.559 33.9997C45.7509 33.9399 45.9102 33.787 46.0251 33.6228C46.1599 33.4299 43.7722 29.4246 42.7512 27.7978V27.7976Z"
        fill="#7C1513"
      />
      <path
        d="M45.413 21.0949C45.3902 20.9361 44.786 20.0323 44.6647 19.9326C44.6353 19.4911 44.0436 19.2365 43.8768 18.822C43.6566 18.2751 42.9801 17.916 42.5626 17.5165C42.1627 17.1339 41.6639 16.8532 41.1609 16.6452C40.607 16.416 40.8623 15.3078 40.2755 15.2064C39.6272 15.0943 39.3319 14.7205 38.6793 14.6339C38.4897 14.4531 37.0817 14.8796 36.8588 15.0256C35.9985 14.9061 35.0208 15.5608 34.1603 15.4413C33.8931 15.4042 30.8891 15.5113 30.7985 15.7746C30.6254 16.2767 28.4321 20.3631 28.4043 20.6301C28.3755 20.9065 30.8676 20.4023 31.1268 20.4958C31.4946 20.6284 36.3887 21.0355 38.4204 21.1197C40.1109 21.3602 41.8386 21.441 43.5424 21.3394C43.8765 21.3194 45.459 21.4141 45.4131 21.0952L45.413 21.0949Z"
        fill="#292B2D"
      />
      <path
        d="M46.3627 24.2458C46.5195 23.9574 46.408 21.9111 46.3607 21.6631C46.4446 21.0323 42.8551 20.925 42.3705 20.8883C36.4666 20.4411 31.794 20.0596 31.8107 20.0585C30.7606 20.1191 26.4592 19.8474 25.4363 20.0585C22.5064 20.6629 23.9498 20.8931 23.8876 21.8956C23.7581 23.9829 23.8396 24.056 23.8876 24.22C23.7273 24.6107 25.0081 24.7739 25.4048 24.8211C30.3629 25.4118 43.2389 25.7016 47.2835 25.5846C47.7504 25.5711 46.3096 24.5812 46.3627 24.2456V24.2458ZM28.0585 22.4315C28.0585 22.4249 28.0582 22.4185 28.0579 22.4122C28.0975 22.4091 28.137 22.406 28.1766 22.4027C28.1372 22.4123 28.098 22.422 28.0585 22.4316V22.4315Z"
        fill="#FC142C"
      />
      <path
        d="M46.9842 25.4078C45.2096 25.3404 39.1749 25.3491 37.3992 25.3379C36.7586 25.2983 36.1178 25.261 35.4773 25.221C34.2893 25.147 33.1014 25.0728 31.9134 24.9987C29.7514 24.8639 26.9098 24.6769 24.7469 24.5543C24.4147 24.5355 22.4435 26.8026 25.6385 27.3048C26.0162 27.6363 26.4276 27.9278 26.8592 28.1839C27.811 28.7481 29.2788 29.8456 30.3495 30.1084C30.9103 30.246 45.6339 34.7743 46.6849 34.3699C47.1678 34.1841 47.2976 25.4199 46.9842 25.408V25.4078Z"
        fill="#FCD92C"
      />
    </g>
    <path
    ...
    />
    <path
      d="M31.6721 12.3023C31.6743 12.4163 31.6706 12.5711 31.6671 12.6823C31.654 13.0921 31.6123 13.5526 31.5321 14.0529C30.6135 19.7752 24.389 23.9931 16.907 22.2972C14.103 21.6615 12.9377 20.6356 11.4442 20.1884C9.03916 19.4684 2.12866 23.955 2.12866 23.955C2.12866 23.955 4.83073 21.2887 7.3169 19.2294C7.97176 19.2154 8.75566 18.3599 7.6125 17.7201C5.32027 16.5076 3.94024 12.1602 4.99013 8.7562C5.01924 8.6614 5.05083 8.56737 5.0829 8.47359C5.09845 8.42888 5.11449 8.38416 5.13052 8.33996C5.13176 8.33663 5.13299 8.33357 5.13447 8.32973C6.38249 5.07978 9.33328 2.84296 12.5922 1.92385C18.8528 0.158209 29.6875 2.96893 31.4352 10.2916C31.4352 10.2916 31.4764 10.461 31.5304 10.7748C31.6178 11.28 31.6614 11.7961 31.6718 12.3026L31.6721 12.3023ZM27.4308 10.0277C27.2573 9.84343 26.85 9.87537 26.7271 10.0203C26.6457 10.1733 26.6792 10.4733 26.7315 10.6355C26.7407 10.6642 26.7508 10.692 26.7611 10.7196C26.8438 10.6683 27.2258 10.1171 27.4308 10.0277Z"
      fill="white"
    />
    <path
...
const Home: React.FC<SvgPropTypes> = ({ size = 34, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g>
      <path
        d="M32.7801 12.8668L26.9902 15.5697L17.0003 20.2327L1.21827 12.8674L16.9998 6.02824L32.7801 12.8668Z"
        stroke={stroke}
      />
      <path d="M9 16.5V24C9 24 11 26.5 17 26.5C23 26.5 25 24 25 24V16.5" stroke={stroke} strokeLinecap="round" />
      <path d="M17 13L4.5 14.5V19.5" stroke={stroke} strokeLinecap="round" />
      <circle cx="4.5" cy="20.5" r="1" stroke={stroke} />
      <path
        d="M2.71937 25.3419L3.88604 21.8419C3.9541 21.6377 4.14516 21.5 4.36038 21.5H4.63962C4.85484 21.5 5.0459 21.6377 5.11396 21.8419L6.28063 25.3419C6.38855 25.6657 6.14757 26 5.80629 26H3.19371C2.85243 26 2.61145 25.6657 2.71937 25.3419Z"
        stroke={stroke}
      />
    </g>
  </svg>
...
const Search: React.FC<SvgPropTypes> = ({ size = 34, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="16" cy="17" r="9.25" stroke={stroke} strokeWidth="1.2" />
    <path d="M22.9994 23.4997L27.9999 27.5001" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
...
const AdminIcon: React.FC<SvgPropTypes> = ({ size = 34, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M15 15.5C15 15.5 12.7212 14 10.5 14C6.35786 14 3 17.3579 3 21.5C3 25.6421 6.35786 29 10.5 29C14.6421 29 18 25.6421 18 21.5C18 20.4333 17.9014 19.4187 17.5 18.5"
      stroke={stroke}
      strokeWidth="1.2"
    />
    <path
      d="M15 15.5L29.2831 5.2839C29.5037 5.12612 29.8098 5.17297 29.9731 5.3895L31.0537 6.8221C31.2162 7.03765 31.1783 7.34332 30.968 7.51263L28.8959 9.18103C28.6782 9.35628 28.6465 9.6759 28.8253 9.89057L30.6733 12.1081C30.8525 12.3232 30.8202 12.6436 30.6015 12.8186L28.8825 14.1938C28.6699 14.3638 28.3603 14.3326 28.1861 14.1234L26.3039 11.8648C26.1335 11.6604 25.8327 11.6252 25.6198 11.7849L24.4208 12.6842C24.1919 12.8559 24.1535 13.1844 24.3367 13.4042L26.1733 15.6081C26.3525 15.8232 26.3202 16.1436 26.1015 16.3186L24.3825 17.6938C24.1699 17.8638 23.8603 17.8326 23.6861 17.6234L21.8277 15.3934C21.6479 15.1776 21.3257 15.1522 21.1143 15.3372L17.4991 18.5002"
      stroke={stroke}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
...
const Statistic: React.FC<SvgPropTypes> = ({ size = 34, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="6.6" y="21.6" width="4.8" height="8.8" rx="0.6" stroke={stroke} strokeWidth="1.2" />
    <rect x="14.6" y="17.6" width="4.8" height="12.8" rx="0.6" stroke={stroke} strokeWidth="1.2" />
    <rect x="22.6" y="13.6" width="4.8" height="16.8" rx="0.6" stroke={stroke} strokeWidth="1.2" />
    <path d="M27.5 7V4H24.5" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
    <path d="M27 4.5L18.5 12.5L11.5 10.5L7 17.5" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
...
const Login: React.FC<SvgPropTypes> = ({ size = 24, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M10.1562 21.5747V27.086C10.1562 27.7488 10.6935 28.286 11.3562 28.286H22.3789C23.0416 28.286 23.5789 27.7488 23.5789 27.086V7.11504C23.5789 6.4523 23.0416 5.91504 22.3789 5.91504H11.3563C10.6935 5.91504 10.1562 6.4523 10.1562 7.11504V12.6263"
      stroke={stroke}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
    <path
      d="M25.8164 6.47041C25.8164 6.12495 25.9947 5.80395 26.288 5.62141L28.9716 3.95122C29.6377 3.53665 30.5 4.01564 30.5 4.80022V29.2647C30.5 30.0353 29.6653 30.5163 28.9986 30.13L26.315 28.5749C26.0064 28.396 25.8164 28.0663 25.8164 27.7096V6.47041Z"
      stroke={stroke}
      strokeWidth="1.2"
    />
    <path d="M3 16.9893L17.9868 16.9897" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
    <path
      d="M15.0938 13.1855L18.5593 16.6511C18.7546 16.8464 18.7546 17.163 18.5593 17.3582L15.0938 20.8238"
      stroke={stroke}
      strokeWidth="1.2"
      strokeLinecap="round"
    />
    <line x1="28.8102" y1="18.1783" x2="28.8102" y2="16.0227" stroke={stroke} strokeWidth="1.2" strokeLinecap="round" />
  </svg>
);
...
const De: React.FC<SvgPropTypes> = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip)">
      <rect x="0" y="0" width="26" height="8.66" fill="#000000" />
      <rect x="0" y="8.66" width="26" height="8.66" fill="#DD0000" />
      <rect x="0" y="17.32" width="26" height="8.68" fill="#FFCE00" />
    </g>
  </svg>
);
...
const Ua: React.FC<SvgPropTypes> = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg">
    ...
    <g clipPath="url(#clip)">
      <rect x="0" y="0" width="26" height="13" fill="#0057B7" />
      <rect x="0" y="13" width="26" height="13" fill="#FFD700" />
    </g>
  </svg>
);
...
const En: React.FC<SvgPropTypes> = ({ size = 26 }) => (
  <svg width={size} height={size} viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M10.7295 18.207L5.39355 23.542C4.81897 23.1267 4.27988 22.6657 3.78125 22.1641L9.23438 16.7119L10.7295 18.207ZM23.583 20.5488C23.1655 21.1331 22.7016 21.6818 22.1953 22.1885L16.9365 16.9297L18.4502 15.416L23.583 20.5488ZM9.14941 9.12988L7.62012 10.6592L2.41406 5.45312C2.83569 4.86277 3.30519 4.30897 3.81738 3.79785L9.14941 9.12988ZM20.5127 2.38867C21.1162 2.81676 21.6809 3.29596 22.2021 3.81836L16.8398 9.18164L15.2803 7.62207L20.5127 2.38867Z"
      fill="#D80027"
    />
    <path
      d="M13 0C14.3956 0 15.7399 0.219878 17 0.626953V9H25.373C25.7801 10.2601 26 11.6044 26 13C26 14.3956 25.7801 15.7399 25.373 17H17V25.3721C15.7398 25.7792 14.3957 26 13 26C11.6043 26 10.2602 25.7792 9 25.3721V17H0.626953C0.219878 15.7399 0 14.3956 0 13C0 11.6044 0.219878 10.2601 0.626953 9H9V0.626953C10.2601 0.219878 11.6044 0 13 0Z"
      fill="white"
    />
    <path
      d="M13 0C13.6801 0 14.3481 0.0516853 15 0.152344V11H25.8467C25.9474 11.652 26 12.3198 26 13C26 13.6802 25.9474 14.348 25.8467 15H15V25.8467C14.348 25.9474 13.6802 26 13 26C12.3198 26 11.652 25.9474 11 25.8467V15H0.15332C0.052647 14.348 0 13.6802 0 13C0 12.3198 0.052647 11.652 0.15332 11H11V0.152344C11.6519 0.0516853 12.3199 0 13 0Z"
      fill="#D80027"
    />
  </svg>
);
...
const SidebarIcon: React.FC<SvgPropTypes> = ({ size = 34, stroke }) => (
  <svg width={size} height={size} viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="1" y="7" width="32" height="20" rx="5" stroke={stroke} strokeWidth="2" />
    <line x1="12.4" y1="27" x2="12.4" y2="7" stroke={stroke} strokeWidth="2" />
  </svg>
);
