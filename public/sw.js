const STATIC_CACHE = 'wortkraft-static-v4';
const RUNTIME_CACHE = 'wortkraft-runtime-v4';
const IMAGE_CACHE = 'wortkraft-images-v4';
...
function getOfflinePage(pathname) {
  ...
  if (pathname.startsWith('/uk')) return '/offline.uk.html';
